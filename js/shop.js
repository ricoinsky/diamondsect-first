...
function getCategoryPlaceholder(category){
  ...
  if(c.includes('terno')) return "assets/hero/hero-ternos.jpg";
  if(c.includes('linho')) return "assets/hero/hero-linho.jpg";
  if(c.includes('joia')) return "assets/hero/hero-joias.jpg";
  if(c.includes('perf')) return "assets/hero/hero-perfumaria.jpg";
  if(c.includes('blazer')) return "assets/hero/hero-blazer.jpg";
